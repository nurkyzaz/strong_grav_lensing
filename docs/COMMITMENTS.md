...
| C8 | Emails: Busillo (shared-29) SENT by Nurkyz ~2026-07-12/13 (reply pending; nudge ~07-20); Bergamini (HST2EUCLID), TinyLensGPU authors, Brian — still to send | 2026-07-10, upd. 07-13 | IN-PROGRESS | EMAIL_DRAFTS_20260710.md |
...
| C16 | LEMON head-to-head program (Q1a–Q3): reconstruct their exact 60-lens Euclidised sample (31 non-SLACS from cited tables; 29 SLACS via email/H-flags/H-fig9) + native Q1-354 eval vs PyAutoLens GT — full staging in LEMON_HEADTOHEAD_PLAN.md | Nurkyz directive 2026-07-13 | IN-PROGRESS (Q0 done; Q1a/Q2a started) | LEMON_HEADTOHEAD_PLAN.md checklist, reconciled at every ⛔ |
| C17 | Q2c flux/ZP gate on real VIS cutouts BEFORE any Q1 eval (LEMON needed −0.22 mag; measure ours, don't assume) | LEMON plan 2026-07-13 | OPEN | Q2c gate script + DECISIONS_LOG |
| C18 | New real-lens files (real_lemon31, Q1 cutouts) frozen at creation; every eval on them logged with the running count | LEMON plan 2026-07-13 | OPEN (standing rule extension) | DECISIONS_LOG eval entries |
