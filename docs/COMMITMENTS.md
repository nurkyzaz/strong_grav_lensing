...
| C16 | LEMON head-to-head program (Q1a–Q3): reconstruct their exact 60-lens Euclidised sample + native Q1-354 eval vs PyAutoLens GT — full staging in MASTER_PLAN.md §2. **UPDATE 2026-07-22: their per-lens predictions received → SLACS-29 RESOLVED; head-to-head recomputed vs Bolton (results/lemon_vs_ours_slacs29.csv; we win every metric). Remaining: EEL-12/COSMOS-5/ACS-13 recompute vs their respective GT, then the paper table.** | Nurkyz directive 2026-07-13 | IN-PROGRESS (Q0 done; Q1a SLACS done; EEL/COSMOS/ACS next) | MASTER_PLAN.md §2 + §6 checklist, reconciled at every ⛔ |
